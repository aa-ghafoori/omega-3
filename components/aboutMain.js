...
const AboutMain = () => {
  return (
    <Fragment>
      <div className='py-28'>
        <h2 className='text-3xl font-bold md:text-4xl text-center text-primary'>
      ...
      <div className='responsive padding paddingy text-primary flex flex-col justify-center'>
        ...
        <article className=' lg:flex-auto text-tertiary'>
          <h2 className='text-secondary my-10 font-bold'>About Us</h2>
          <h2 className='text-3xl font-bold md:text-5xl capitalize text-primary'>
